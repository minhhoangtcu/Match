...
public class DisplayPersonController {
	...
	private void popupPerson(Person person, boolean isDisable) {
		...
		isColored = !isColored;
		PersonComponentPopup.popupString(MATCHES_AVAILABLE, person.getNumMatchesAvaiable() + "", gridPane, row++,
				isDisable, isColored);
		isColored = !isColored;
		...
		for (Attribute attribute : person.getAttributes()) {
			...
			case GENERAL:
				PersonComponentPopup.popupString(attribute.getAttributeName(),
